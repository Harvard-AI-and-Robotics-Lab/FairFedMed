...
class DatasetWrapperOph(TorchDataset):
    ...
    def count_by_attribute(self, attr):
        ...
        for item, data_file in enumerate(self.data_source.data_files):
            data_file = os.path.join(
                ...
                self.data_source.data_files[item]
            )
    ...
    def __getitem__(self, idx):
        img0, label, attrs = self.data_source[idx]
    ...
    def _transform_image(self, tfm, img0):
        img0 = self.ensure_pil_image(img0)
    ...
    def ensure_pil_image(self, image):
        ...
        # Check if the image is a NumPy array
            ...
            if image.shape[0] == 3:
                ...
                assert image.shape[-1] == 3, 'input shape should be height x width x 3'
            # Convert the NumPy array to a PIL Image
            return Image.fromarray(image, 'RGB')
        else:
            raise TypeError("Unsupported image type. Must be a PIL Image or a NumPy array.")