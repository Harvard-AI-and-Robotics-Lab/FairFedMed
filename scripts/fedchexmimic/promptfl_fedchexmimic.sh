...
do
  ...
  do
    for SEED in 1
    do
      DIR=output/fedchexmimic/${MODEL}_${CFG}/${DATASET}_${PARTITION}_beta${BETA}_normalize/${MODEL}_${TRAINER}_${OT}_${TOP_PERCENT}_eps${EPS}_${ATTRIBUTE_TYPE}/nctx${NCTX}_csc${CSC}_ctp${CTP}/iid_${IID}_${USERS}users_${FRAC}frac_lr${LR}_${ROUND}round_seed${SEED}_${timestamp}
      if [ -d "$DIR" ]; then
